...
extensions = ['sphinx.ext.intersphinx', 'doctrineprojects', 'doctrinedownloads', 'sphinxcontrib.feed', 'configurationblock']
...
html_title = 'Doctrine-Project'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Homepage'
