...
def visit_doctrinedownloads_html(self, node):
    ...
    self.body.append('<ul class="nav nav-pills">')
    ...
    for version in projectVersions:
        ...
        self.body.append('<div class="panel-heading"><h3 class="panel-title">Download %s (%s)<a name="version%s"></h3></div>' % ( version, stability, version ))
